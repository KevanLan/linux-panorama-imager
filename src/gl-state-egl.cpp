...
bool GLStateEGL::init_surface(void* native_window)
{
...
void GLStateEGL::init_gl_extensions()
{
...
void GLStateEGL::swap()
{
    eglSwapBuffers(egl_display_, egl_surface_);
}

bool GLStateEGL::gotNativeConfig(int& vid)
{
    if (!gotValidConfig())
        return false;
...
void GLStateEGL::getVisualConfig(GLVisualConfig& vc)
{
    if (!gotValidConfig())
        return;
...
bool GLStateEGL::gotValidDisplay()
{
    if (egl_display_)
        return true;
...
void GLStateEGL::get_glvisualconfig(EGLConfig config, GLVisualConfig& visual_config)
{
...
EGLConfig GLStateEGL::select_best_config(std::vector<EGLConfig>& configs)
{
...
bool GLStateEGL::gotValidConfig()
{
    if (egl_config_)
        return true;
...
bool GLStateEGL::gotValidSurface()
{
    if (egl_surface_)
        return true;
...
bool GLStateEGL::gotValidContext()
{
    if (egl_context_)
        return true;
