...
bool NativeStateDRM::init_display()
{
    if (!dev_)
        init();
...
void* NativeStateDRM::display()
{
    return static_cast<void*>(dev_);
}

bool NativeStateDRM::create_window(WindowProperties const& /*properties*/)
{
    if (!dev_) {
...
void* NativeStateDRM::window(WindowProperties& properties)
{
...
void NativeStateDRM::visible(bool /*visible*/)
{
}

bool NativeStateDRM::should_quit()
{
    return should_quit_;
}

int NativeStateDRM::get_fd()
{
    return fd_;
}

void NativeStateDRM::flip()
{
...
void NativeStateDRM::fb_destroy_callback(gbm_bo* bo, void* data)
{
...
NativeStateDRM::DRMFBState* NativeStateDRM::fb_get_from_bo(gbm_bo* bo)
{
...
void NativeStateDRM::quit_handler(int /*signo*/)
{
    should_quit_ = true;
}

void NativeStateDRM::page_flip_handler(int/*  fd */, unsigned int /* frame */, unsigned int /* sec */, unsigned int /* usec */, void* data)
{
    unsigned int* waiting = reinterpret_cast<unsigned int*>(data);
    *waiting = 0;
}

void NativeStateDRM::cleanup()
{
